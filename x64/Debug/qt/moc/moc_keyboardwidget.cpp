...
QT_MOC_LITERAL(1, 15, 12), // "digitClicked"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 15), // "operatorClicked"
QT_MOC_LITERAL(4, 45, 12) // "equalClicked"

    },
    "KeyboardWidget\0digitClicked\0\0"
    "operatorClicked\0equalClicked"
};
...
void KeyboardWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (KeyboardWidget::*_t)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&KeyboardWidget::digitClicked)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (KeyboardWidget::*_t)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&KeyboardWidget::operatorClicked)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (KeyboardWidget::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&KeyboardWidget::equalClicked)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void KeyboardWidget::digitClicked(QString _t1)
{
...
// SIGNAL 1
void KeyboardWidget::operatorClicked(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void KeyboardWidget::equalClicked()
{
