...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_HistoryManager_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_HistoryManager_t qt_meta_stringdata_HistoryManager = {
    {
QT_MOC_LITERAL(0, 0, 14), // "HistoryManager"
QT_MOC_LITERAL(1, 15, 14), // "historyChanged"
QT_MOC_LITERAL(2, 30, 0) // ""

    },
    "HistoryManager\0historyChanged\0"
};
...
void HistoryManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HistoryManager::historyChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject HistoryManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_HistoryManager.data,
      qt_meta_data_HistoryManager,  qt_static_metacall, nullptr, nullptr}
};
